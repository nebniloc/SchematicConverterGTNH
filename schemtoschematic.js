...
function findUnknownBlocks(arrayBuffer, callback, customMappings) {
    nbt.parse(arrayBuffer, function(error, root) {
        ...
        if ('Schematic' in root.value && 'Blocks' in root.value.Schematic.value && 'Palette' in root.value.Schematic.value.Blocks.value) {
...
if (typeof module !== 'undefined') {
    module.exports = { schemtoschematic: schemtoschematic, findUnknownBlocks: findUnknownBlocks };
}
